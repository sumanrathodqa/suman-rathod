...
var createAllureFullName = test => {
  ...
  return test.file ? "".concat(getPosixPath(getRelativePath(test.file)), ": ").concat(titlePath) : titlePath;
};
...
export var getAllureMetaLinks = test => getAllureData(test).links;
...
export var getTestCaseId = test => {
  var testFilePath = test.file ? getPosixPath(getRelativePath(test.file)) : "";
