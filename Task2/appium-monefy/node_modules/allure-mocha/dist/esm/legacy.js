...
class LegacyAllureApi {
  constructor() {
     ...
     */
    _defineProperty(this, "parameter", (name, value, options) => Promise.resolve(commons.parameter(name, serialize(value), options)));
    /**
    ...
    _defineProperty(this, "writeEnvironmentInfo", info => {
      ...
      (_getLegacyApiRuntime = getLegacyApiRuntime()) === null || _getLegacyApiRuntime === void 0 || _getLegacyApiRuntime.writeEnvironmentInfo(info);
    });
    /**
    ...
    _defineProperty(this, "writeCategoriesDefinitions", categories => {
      ...
      (_getLegacyApiRuntime2 = getLegacyApiRuntime()) === null || _getLegacyApiRuntime2 === void 0 || _getLegacyApiRuntime2.writeCategoriesDefinitions(categories);
    });
    /**
    ...
    _defineProperty(this, "testAttachment", (name, content, options) => {
      var runtime = getLegacyApiRuntime();
    ...
    _defineProperty(this, "logStep", (name, status) => {
      ...
      runtime === null || runtime === void 0 || runtime.applyRuntimeMessages({
        ...
        type: "step_stop",
        data: {
          status: status !== null && status !== void 0 ? status : Status.PASSED,
          stop: timestamp
        }
      });
    });
    ...
    _defineProperty(this, "renameStep", name => {
      ...
      (_getLegacyApiRuntime3 = getLegacyApiRuntime()) === null || _getLegacyApiRuntime3 === void 0 || _getLegacyApiRuntime3.applyRuntimeMessages({
        type: "step_metadata",
        data: {
          name
        }
    ...
    _defineProperty(this, "addStepParameter", (name, value) => {
      ...
      (_getLegacyApiRuntime4 = getLegacyApiRuntime()) === null || _getLegacyApiRuntime4 === void 0 || _getLegacyApiRuntime4.applyRuntimeMessages({
        type: "step_metadata",
        data: {
          parameters: [{
            name,
    ...
    _defineProperty(this, "stopStepSuccess", () => {
      ...
      (_getLegacyApiRuntime5 = getLegacyApiRuntime()) === null || _getLegacyApiRuntime5 === void 0 || _getLegacyApiRuntime5.applyRuntimeMessages({
        type: "step_stop",
        data: {
    ...
    _defineProperty(this, "stopStepWithError", error => {
      ...
      (_getLegacyApiRuntime6 = getLegacyApiRuntime()) === null || _getLegacyApiRuntime6 === void 0 || _getLegacyApiRuntime6.applyRuntimeMessages({
        type: "step_stop",
        data: {
...
export var allure = new LegacyAllureApi();
