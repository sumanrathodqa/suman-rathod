...
import { applyTestPlan, createTestPlanIndices, getAllureDisplayName, getAllureFullName, getAllureMetaLabels, getAllureMetaLinks, getHookType, getSuitesOfMochaTest, getTestCaseId, getTestScope, isIncludedInTestRun, resolveParallelModeSetupFile, setTestScope } from "./utils.js";
var {
  EVENT_SUITE_BEGIN,
  EVENT_SUITE_END,
  EVENT_TEST_BEGIN,
...
export class AllureMochaReporter extends Mocha.reporters.Base {
  constructor(runner, _opts) {
    ...
    _defineProperty(this, "onTest", test => {
      ...
      var links = getAllureMetaLinks(test);
